...
<div id='recipients' class="p-8 lg:mt-0 rounded shadow bg-white relative overflow-x-auto">
 ...
 <div class="p-6">             
  ...
  <div class="mb-6">
   ...
   <input type="text" name="project_link" id="project_link" value="{{ $project->project_link }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter project link" required>
 </div>
 <div class="mb-6">
  <label for="doc_link" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Documentation Link</label>
  <input type="text" name="doc_link" id="doc_link" value="{{ $project->doc_link }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter documentation link" required>
</div>
<div class="mb-6">
 <label for="github_link" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Github Link</label>
 <input type="text" name="github_link" id="github_link" value="{{ $project->github_link }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter github link" required>
</div>
