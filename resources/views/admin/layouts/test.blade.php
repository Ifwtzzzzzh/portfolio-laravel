<div class="p-6">             
	<form enctype="multipart/form-data" method="POST" action="{{ route('admin.achievement.update', $achievement->id) }}">
	 ...
	 <div class="mb-6">
	  ...
	  <input id="text" name="time" id="time" value="{{ $achievement->name }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="2023" required>
	</div>
	 <div class="mb-6">
	  ...
	  <textarea name="description" id="description" value="{{ $achievement->name }}" id="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a description..."></textarea>
	</div>
	<div class="mb-6">
