...
<div id='recipients' class="p-8 lg:mt-0 rounded shadow bg-white relative overflow-x-auto">
 ...
 <div class="mb-6"></div>
 <a href="{{ route('admin.organization.create') }}" class="button text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mt-4 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Add Achievement</a>
 {{-- ========= END TABLE ========= --}}
</div>
@endsection
