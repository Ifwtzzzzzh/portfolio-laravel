...
<div id='recipients' class="p-8 lg:mt-0 rounded shadow bg-white relative overflow-x-auto">
	...
	{{-- ========= FORM ========= --}}
	<div>             
		<form enctype="multipart/form-data" method="POST" action="{{ route('admin.education.store') }}">
		@csrf
			<div class="mb-6">
			...
			<div class="mb-6">
				...
				<input id="time" name="time" value="{{ old('time') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="2023" required>
			</div>
			<div class="mb-6">
